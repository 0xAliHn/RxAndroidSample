...
import com.android.rxandroid.databinding.ActivitySampleRx2Binding;
...
public class AsynchronousRxActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rx2Binding.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //With just those two lines, we have specified that the blocking/time consuming Observable execute in the background,
                // and whenever it completes, the result should be displayed on the UI.
                myObservable
